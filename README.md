...
<b>P.S.</b> <i>Pyplot</i> and <i>Choropleth</i> can not be displayed using Github code viewer and have to be viewed using NoteBook Viewer (nbviewer) 
...
- <b>Deep Learning</b>: Callbacks Method, Dropout Method.
